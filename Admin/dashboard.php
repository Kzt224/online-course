                    ...
                    <div class=" d-flex flex-column flex">
                          <!-- text content -->
                            <div class="text-cont d-flex flex-row justify-content-between align-items-center p-3 ">
                              <p class="t-white d-flex p-0 m-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione quasi libero quas dignissimos? Ea nobis nemo rerum fugiat architecto iusto doloribus in mollitia, obcaecati quasi. Quis accusantium asperiores voluptates atque?</p>
                            ...
                            <div class="d-flex flex-row mx-3 mb-1">
                                <a href="" class="d-flex text-decoration-none px-1 t-green m-0 mx-2 p-0 align-items-center justify-content-center">
                                  <i class="fa-regular fa-circle p-0 m-0 px-2"></i>
                                  <p class="m-0 p-0">Public</p>
                                </a>
                                <a href="" class="d-flex text-decoration-none px-2 t-blue m-0 mx-2 p-0 align-items-center justify-content-center">
                                  <i class="fa-solid fa-pencil p-0 m-0 px-2"></i>
                                </a>
                                <a href="" class="d-flex text-decoration-none px-2 t-red m-0 mx-2 p-0 align-items-center justify-content-center">
